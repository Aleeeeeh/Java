...
public class Programa {
	public static void main(String args[]) {
		...
		//Para fazer DownCasting precisamos usar o instanceOf em caso do obj não ser da mesma classe 
		...
		accex1.saque(200.0);
		System.out.println("Saldo Disponivel em conta Poupança R$ " + accex1.getSaldo());
